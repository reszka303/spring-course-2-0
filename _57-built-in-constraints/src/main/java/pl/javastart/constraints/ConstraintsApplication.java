...
public class ConstraintsApplication {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext context =
                SpringApplication.run(ConstraintsApplication.class, args);
        ...
        validate(validator, person1);
        validate(validator, person2);
    }

    private static void validate(Validator validator, Person person) {
